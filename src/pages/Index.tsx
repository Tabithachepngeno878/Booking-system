                ...
                <ul className="space-y-3 mb-8">
                  {t.home.booking.benefits.map((item, index) => (
                    <li key={index} className="flex items-start">
                      <div className="h-5 w-5 rounded-full bg-primary/10 text-primary flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">
        ...
        <section className="section">
          <div className="container">
            <div className="mb-12 animate-fade-in">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed max-w-none">
